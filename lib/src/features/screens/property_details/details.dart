...
class PropDetails extends StatefulWidget {
   PropDetails({Key? key, required this.image, required this.title, required this.address, required this.price, required this.onLikeChanged, required this.isLike,}) : super(key: key);
...
class _PropDetailsState extends State<PropDetails> {
  ...
  void shareTextToWhatsApp(String c_code, String phoneNum, String text) async {
    final Uri _url = Uri.parse('https://wa.me/$c_code$phoneNum?text=${Uri.encodeFull(text)}');
  ...
  void openWhatsApp() async {
    final Uri Murl = Uri.parse('https://api.whatsapp.com/send?text=${Uri.encodeFull("Hi, Check out this property on Quatr\nwww.quatr.com.ng/property/23423")}');

    if (!await launchUrl(Murl, mode:LaunchMode.externalNonBrowserApplication,)) {
                  ...
                  Stack(
                          children: [
                            ...
                            child: Container(
                              ...
                              child: CarouselSlider.builder(itemCount: images_data.length,
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Icon(Icons.place, color: Colors.green[400],),
                              Expanded(
                          ...
                          Row(
                            ...
                            children: [
                              Icon(Icons.star, color: Colors.orange[400],),
                                SafeArea(
                                child: Text("$ratings ($reviews Reviews)",
                                    textAlign: TextAlign.start,
                                    style: Theme.of(context).textTheme.titleSmall!.copyWith(
                         ...
                         Row(
                          ...
                          //contact information
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0,right: 8.0,bottom: 8.0, top:12),
                            child: Row(
                              children: [
                                ClipOval(
                                      child: Image(image: AssetImage("assets/images/landlord1.jpg",), fit: BoxFit.cover,height: 45,width: 45,),
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: IconButton(
                                        ...
                                        onPressed: () {
                                          shareTextToWhatsApp('+1', '3068509733', "Hi Jide, I want to make enquiry on your quatr post");
                                        },
                                      ),
                                    ),
                                    SizedBox(width: 20,),
