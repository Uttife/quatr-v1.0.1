import 'package:Quatr/src/screens/profile/profile_screen.dart';
import 'package:flutter/material.dart';
import '../../common_widgets/clickable_round_image.dart';
...
class MyApplications extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: Icon(Icons.collections_bookmark_rounded, color: Colors.black,),
      title: MyText(text: "My Applications",
          fontSize: 16,
          fontWeight: FontWeight.bold,
          textAlign: TextAlign.start),
    );
...
class SavedListings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: Icon(Icons.favorite, color: Colors.black,),
      title: MyText(text: "Saved Listings",
          fontSize: 16,
          fontWeight: FontWeight.bold,
          textAlign: TextAlign.start),
    );
...
class AccountSettings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: MyText(text: "Account Settings",
          fontSize: 16,
          fontWeight: FontWeight.bold,
      textAlign: TextAlign.start),
    );
