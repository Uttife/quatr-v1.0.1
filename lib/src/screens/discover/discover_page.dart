      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                MyText(text: "Discover", fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white,),
                SizedBox(
                  height:
                      MediaQuery.of(context).size.height * 0.0045,
                ),
                MyText(text: "Find your next home", fontSize: 12,color: Colors.white,),
                SizedBox(
                  height:
          ...
          Positioned(
            child:
            ClipRRect(
              child: Image.asset("assets/images/houseNig.jpg",
                height: MediaQuery.of(context).size.height * 0.15,
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              MyText(text:"Search Quatr",fontSize: 12,color: Colors.black54,textAlign: TextAlign.center,)
            ],
          ),
        ),
      ),
